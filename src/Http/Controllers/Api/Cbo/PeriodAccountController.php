...
class PeriodAccountController extends Controller {
	public function index(Request $request) {
		$query = Models\Cbo\PeriodAccount::select('id', 'code', 'name', 'memo');
	...
	public function store(Request $request) {
		...
		$oid = $request->input('calendar.id');
		if ($oid) {
			$input['calendar_id'] = $oid;
		}
		$data = Models\Cbo\PeriodAccount::create($input);
	...
	public function destroy(Request $request, $id) {
		$ids = explode(",", $id);
		Models\Cbo\PeriodAccount::destroy($ids);
