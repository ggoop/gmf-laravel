...
class TraderCategoryController extends Controller {
	public function index(Request $request) {
		$query = Models\Cbo\TraderCategory::select('id', 'code', 'name', 'memo');
	...
	public function store(Request $request) {
		...
		$data = Models\Cbo\TraderCategory::create($input);
	...
	public function update(Request $request, $id) {
		...
		if (!Models\Cbo\TraderCategory::where('id', $id)->update($input)) {
	...
	public function destroy(Request $request, $id) {
		$ids = explode(",", $id);
		Models\Cbo\TraderCategory::destroy($ids);
