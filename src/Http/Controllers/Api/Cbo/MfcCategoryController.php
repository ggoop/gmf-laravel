...
class MfcCategoryController extends Controller {
	public function index(Request $request) {
		$query = Models\Cbo\MfcCategory::select('id', 'code', 'name', 'memo');
	...
	public function store(Request $request) {
		...
		$data = Models\Cbo\MfcCategory::create($input);
	...
	public function update(Request $request, $id) {
		...
		if (!Models\Cbo\MfcCategory::where('id', $id)->update($input)) {
	...
	public function destroy(Request $request, $id) {
		$ids = explode(",", $id);
		Models\Cbo\MfcCategory::destroy($ids);
