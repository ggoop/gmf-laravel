  ...
  <md-part>
    ...
    <md-part-body>
      <md-content>
        <md-input-container>
          <label>分类</label>
          <md-input-ref md-ref-id="gmf.cbo.mfc.category.ref" placeholder="选择或添加分类" v-model="model.main.category"/>
        </md-input-container>
        <md-input-container>
          <label>编码</label>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        this.$router.push({ name: 'module', params: { module: 'cbo.mfc.list' }});
      },
    },
    created() {
      this.route='cbo/mfcs';
