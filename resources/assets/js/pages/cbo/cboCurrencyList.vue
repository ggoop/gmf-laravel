<template>
  <md-part>
    ...
    <md-part-body>
      <md-query @select="select" @dblclick="edit" ref="list" md-query-id="gmf.cbo.currency.list"></md-query>
...
<script>
  export default {
    ...
    methods: {
      create(){
        this.$router.push({ name: 'module', params: { module: 'cbo.currency.edit' }});
      },
      edit(item){
        this.$router.push({ name: 'id', params: { module: 'cbo.currency.edit',id:item.id }});
      },
      remove(){
