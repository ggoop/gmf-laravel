<template>
  <md-part>
    ...
    <md-part-body>
      <md-query @select="select" @dblclick="edit" ref="list" md-query-id="gmf.cbo.period.account.list"></md-query>
...
<script>
  export default {
    ...
    methods: {
      create(){
        this.$router.push({ name: 'module', params: { module: 'cbo.period.account.edit' }});
      },
      edit(item){
        this.$router.push({ name: 'id', params: { module: 'cbo.period.account.edit',id:item.id }});
      },
      remove(){
