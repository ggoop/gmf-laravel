<template>
  <md-part>
    ...
    <md-part-body>
      <md-query @select="select" @dblclick="edit" ref="list" md-query-id="gmf.cbo.project.list"></md-query>
...
<script>
  export default {
    ...
    methods: {
      create(){
        this.$router.push({ name: 'module', params: { module: 'cbo.project.edit' }});
      },
      edit(item){
      ...
      remove(){
        ...
        this.$http.delete('cbo/projects/'+ids).then(response => {
          this.load();
          this.loading--;
